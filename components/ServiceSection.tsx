  ...
  const services = [
    {
      ...
      description:
        "Premium tractors, harvesters, and specialized farming equipment from leading manufacturers.",
    ...
    },
    {
      ...
      description:
        "Professional maintenance and repair services to keep your machinery running at peak performance.",
    ...
    },
    {
      ...
      description:
        "Flexible rental solutions for seasonal needs or equipment trials before purchase.",
    ...
    },
    {
      ...
      description:
        "Comprehensive training for operators and maintenance staff on modern agricultural equipment.",
      features: [
    ...
    },
    {
      ...
      description:
        "Tailored mechanization solutions designed specifically for your farm's unique requirements.",
    ...
    },
    {
      ...
      title: "24/7 Support",
      description:
        "Round-the-clock technical support and emergency services to minimize downtime.",
      features: [
        "Emergency response",
        "Remote diagnostics",
        "Parts availability",
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center bg-primary/5 rounded-2xl p-8 border border-primary/10">
          ...
          <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
            Let our experts help you choose the right mechanization solutions
            for your specific needs. Get a personalized consultation and quote
            today.
          </p>
