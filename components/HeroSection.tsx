...
export default function HeroSection({ data }: HeroSectionProps) {
  ...
  return (
    <section
      id="home"
      className="relative min-h-screen flex items-center bg-gradient-to-br from-background to-agricultural-earth-light"
    >
          ...
          <div className="hidden relative lg:block ">
            ...
            <div className="absolute -bottom-12 -left-12 bg-card p-3 rounded-xl shadow-lg border">
              <div className="text-center">
                ...
                <div className="text-sm sm:text-xsm text-muted-foreground">
                  Hectres <span className="text-primary block">Targeted</span>
                </div>
              </div>
            </div>
            ...
            <div className="absolute -top-12 -right-6 bg-card p-3 rounded-xl shadow-lg border">
              <div className="text-center">
                <div className="text-2xl font-bold text-agricultural-earth">
                  300+
                </div>
                <div className="text-sm sm:text-xsm text-muted-foreground">
                  Tractors &
                  <span className="text-primary block">Implements</span>
                </div>
              </div>
            </div>
          </div>
