...
export default function ManageArticle() {
  ...
  const getSuggestedArticles = async (slug: string) => {
  ...
  const getArticle = async (slug: string) => {
    ...
    setArticle(json.data[0] as Article);
  };

  useEffect(() => {
    getSuggestedArticles(params.slug as string);
    getArticle(params.slug as string);
  }, []);
